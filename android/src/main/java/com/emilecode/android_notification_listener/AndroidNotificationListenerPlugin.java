 ...
 * NotificationsPlugin
 */
public class AndroidNotificationListenerPlugin implements EventChannel.StreamHandler {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    AndroidNotificationListenerPlugin plugin = new AndroidNotificationListenerPlugin(context);
  ...
  class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      //Log.d("notification Received",packageExtra);
      HashMap<String, Object> map = new HashMap<>();
      map.put("packageName",packageName);
      map.put("packageMessage", packageMessage);
      map.put("packageText",packageText);
      map.put("packageExtra",packageExtra);
      try {
        eventSink.success(map);
      }catch (Exception error)
      {
        //Log.d("notification fair error", "no receiver found by the notification package\n");
      }
